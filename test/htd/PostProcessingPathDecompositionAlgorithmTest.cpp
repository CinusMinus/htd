/*
 * File:   PostProcessingPathDecompositionAlgorithmTest.cpp
 *
...
class PostProcessingPathDecompositionAlgorithmTest : public ::testing::Test
{
    public:
        PostProcessingPathDecompositionAlgorithmTest(void)
        {

        }

        virtual ~PostProcessingPathDecompositionAlgorithmTest()
        {
...
TEST(PostProcessingPathDecompositionAlgorithmTest, CheckResultEmptyGraph)
{
...
TEST(PostProcessingPathDecompositionAlgorithmTest, CheckResultDisconnectedGraph)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
    ...
    {
        ASSERT_LE(decomposition->childCount(vertex), (std::size_t)1);
    }
...
TEST(PostProcessingPathDecompositionAlgorithmTest, CheckResultSimpleGraph)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(PostProcessingPathDecompositionAlgorithmTest, CheckResultSimpleGraphWithLabelingFunction)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(PostProcessingPathDecompositionAlgorithmTest, CheckResultSimpleGraphWithLabelingFunctionVector)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(PostProcessingPathDecompositionAlgorithmTest, CheckResultSimpleGraphWithLabelingFunctionVectorAndManipulationOperation)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
    ...
    htd::PostProcessingPathDecompositionAlgorithm algorithm(libraryInstance, { new BagSizeLabelingFunction(libraryInstance),
