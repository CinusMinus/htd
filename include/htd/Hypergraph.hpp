...
namespace htd
{
    ...
    class Hypergraph : public virtual htd::IMutableHypergraph
    {
        public:
            ...
            HTD_API void removeEdge(const std::vector<htd::vertex_t> & elements) override;

            HTD_API void removeEdge(const htd::ConstCollection<htd::vertex_t> & elements) override;
            ...
            HTD_API Hypergraph * clone(void) const override;
#else
            /**
...
#ifndef HTD_USE_VISUAL_STUDIO_COMPATIBILITY_MODE
            HTD_API Hypergraph & operator=(const htd::IHypergraph & original) override;
#else
