/* 
 * File:   TrivialTreeDecompositionAlgorithm.hpp
 * 
...
#ifndef HTD_HTD_TRIVIALTREEDECOMPOSITIONALGORITHM_HPP
#define HTD_HTD_TRIVIALTREEDECOMPOSITIONALGORITHM_HPP
...
{
    /**
     *  Implementation of the ITreeDecompositionAlgorithm interface which
     *  returns the trivial tree decomposition consisting of only one bag
     *  which captures the whole graph.
     */
    class TrivialTreeDecompositionAlgorithm : public htd::ITreeDecompositionAlgorithm
    {
        public:
            /**
             *  Constructor for a trivial tree decomposition algorithm.
             *
             *  @param[in] manager  The management instance to which the new algorithm belongs.
             */
            HTD_API TrivialTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager);
             ...
             */
            HTD_API TrivialTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations);

            /**
             *  Copy constructor for a htd::TrivialTreeDecompositionAlgorithm object.
             *
             *  @param[in] original The original htd::TrivialTreeDecompositionAlgorithm object.
             */
            HTD_API TrivialTreeDecompositionAlgorithm(const htd::TrivialTreeDecompositionAlgorithm & original);

            HTD_API virtual ~TrivialTreeDecompositionAlgorithm();

            HTD_API htd::ITreeDecomposition * computeDecomposition(const htd::IMultiHypergraph & graph) const override;

            HTD_API htd::ITreeDecomposition * computeDecomposition(const htd::IMultiHypergraph & graph, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations) const override;
            ...
            HTD_API htd::ITreeDecomposition * computeDecomposition(const htd::IMultiHypergraph & graph, const htd::IPreprocessedGraph & preprocessedGraph, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations) const override;
            ...
            HTD_API TrivialTreeDecompositionAlgorithm * clone(void) const override;

        protected:
            /**
             *  Copy assignment operator for a trivial tree decomposition algorithm.
             *
             *  @note This operator is protected to prevent assignments to an already initialized algorithm.
             */
            TrivialTreeDecompositionAlgorithm & operator=(const TrivialTreeDecompositionAlgorithm &) { return *this; }
...
#endif /* HTD_HTD_TRIVIALTREEDECOMPOSITIONALGORITHM_HPP */
