/*
 * File:   JoinNodeComplexityReductionOperation.hpp
 *
...
#ifndef HTD_HTD_JOINNODECOMPLEXITYREDUCTIONOPERATION_HPP
#define HTD_HTD_JOINNODECOMPLEXITYREDUCTIONOPERATION_HPP
...
{
    /**
     *  Implementation of the IDecompositionManipulationOperation interface which
     *  manipulates given tree decompositions in such a way that no vertex is
     *  removed in join nodes.
     */
    class JoinNodeComplexityReductionOperation : public virtual htd::ITreeDecompositionManipulationOperation
    {
        public:
            /**
             *  Constructor for a new manipulation operation of type JoinNodeComplexityReductionOperation.
             *
             *  @param[in] manager   The management instance to which the new manipulation operation belongs.
             */
            HTD_API JoinNodeComplexityReductionOperation(const htd::LibraryInstance * const manager);

            HTD_API virtual ~JoinNodeComplexityReductionOperation();
            ...
            HTD_API JoinNodeComplexityReductionOperation * clone(void) const override;
#else
            /**
             *  Create a deep copy of the current decomposition manipulation operation.
             *
             *  @return A new JoinNodeComplexityReductionOperation object identical to the current decomposition manipulation operation.
             */
            HTD_API JoinNodeComplexityReductionOperation * clone(void) const;
...
#endif /* HTD_HTD_JOINNODECOMPLEXITYREDUCTIONOPERATION_HPP */
