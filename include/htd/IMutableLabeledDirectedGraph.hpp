...
{
    /**
     * Interface for classes which represent mutable labeled directed graphs.
     */
    class IMutableLabeledDirectedGraph : public virtual htd::ILabeledDirectedGraph, public virtual htd::IMutableDirectedGraph
    {
        public:
            ...
            using htd::IMutableDirectedGraph::assign;
#endif

            /**
             *  Destructor for an IMutableLabeledDirectedGraph object.
             */
             ...
             */
            virtual IMutableLabeledDirectedGraph * clone(void) const override = 0;
#else
            /**
             *  Create a deep copy of the current mutable labeled directed graph.
             *
