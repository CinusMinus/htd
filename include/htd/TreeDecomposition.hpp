...
namespace htd
{
    ...
    class TreeDecomposition : public htd::LabeledTree, public virtual htd::IMutableTreeDecomposition
    {
        public:
            ...
            HTD_API TreeDecomposition * clone(void) const override;
#else
            /**
...
#ifndef HTD_USE_VISUAL_STUDIO_COMPATIBILITY_MODE
            HTD_API TreeDecomposition & operator=(const htd::ITree & original) override;

            HTD_API TreeDecomposition & operator=(const htd::ILabeledTree & original) override;

            HTD_API TreeDecomposition & operator=(const htd::ITreeDecomposition & original) override;
#else
