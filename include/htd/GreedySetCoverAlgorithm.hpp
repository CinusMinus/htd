/* 
 * File:   GreedySetCoverAlgorithm.hpp
 *
...
#ifndef HTD_HTD_GREEDYSETCOVERALGORITHM_HPP
#define HTD_HTD_GREEDYSETCOVERALGORITHM_HPP
...
namespace htd
{
    ...
    class GreedySetCoverAlgorithm : public htd::ISetCoverAlgorithm
    {
        public:
            ...
            HTD_API GreedySetCoverAlgorithm * clone(void) const override;
...
#endif /* HTD_HTD_GREEDYSETCOVERALGORITHM_HPP */
