...
namespace htd
{
    ...
    class ConstIteratorBase
    {
        public:
             ...
             */
            virtual ConstIteratorBase<T> & operator++(void) noexcept = 0;
             ...
             */
            virtual bool operator==(const ConstIteratorBase<T> & rhs) const noexcept = 0;
             ...
             */
            virtual ConstIteratorBase<T> * clone(void) const noexcept = 0;
    };
