...
namespace htd
{
    ...
    class LabeledHypergraph : public htd::LabeledGraphType<htd::Hypergraph>, public virtual htd::IMutableLabeledHypergraph
    {
        public:
            ...
            HTD_API LabeledHypergraph * clone(void) const override;
#else
            /**
            ...
            HTD_API htd::IMutableHypergraph * cloneMutableHypergraph(void) const override;

            HTD_API htd::IMutableLabeledHypergraph * cloneMutableLabeledHypergraph(void) const override;
#endif
...
#ifndef HTD_USE_VISUAL_STUDIO_COMPATIBILITY_MODE
            HTD_API LabeledHypergraph & operator=(const htd::IHypergraph & original) override;

            HTD_API LabeledHypergraph & operator=(const htd::ILabeledHypergraph & original) override;
#else
            ...
            HTD_API void assign(const htd::IHypergraph & original) override;

            HTD_API void assign(const htd::ILabeledHypergraph & original) override;
#endif
    };
}
