...
namespace htd
{
    ...
    class CliqueMinimalSeparatorAlgorithm : public htd::IGraphSeparatorAlgorithm
    {
        public:
            ...
            HTD_API std::vector<htd::vertex_t> * computeSeparator(const htd::IGraphStructure & graph) const override;
            ...
            HTD_API CliqueMinimalSeparatorAlgorithm * clone(void) const override;
