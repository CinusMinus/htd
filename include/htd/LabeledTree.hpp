...
namespace htd
{
    ...
    class LabeledTree : public htd::LabeledGraphType<htd::Tree>, public virtual htd::IMutableLabeledTree
    {
        public:
            ...
            HTD_API LabeledTree * clone(void) const override;
#else
            /**
...
#ifndef HTD_USE_VISUAL_STUDIO_COMPATIBILITY_MODE
            HTD_API LabeledTree & operator=(const htd::ITree & original) override;

            HTD_API LabeledTree & operator=(const htd::ILabeledTree & original) override;
#else
