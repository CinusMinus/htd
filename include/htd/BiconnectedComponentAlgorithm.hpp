...
namespace htd
{
    ...
    class BiconnectedComponentAlgorithm : public htd::IBiconnectedComponentAlgorithm
    {
        public:
            ...
            HTD_API void determineComponents(const htd::IGraphStructure & graph, std::vector<std::vector<htd::vertex_t>> & target, std::vector<htd::vertex_t> & articulationPoints) const override;

            HTD_API void determineComponent(const htd::IGraphStructure & graph, htd::vertex_t startingVertex, std::vector<htd::vertex_t> & target, std::vector<htd::vertex_t> & articulationPoints) const override;
            ...
            HTD_API BiconnectedComponentAlgorithm * clone(void) const override;
