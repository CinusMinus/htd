/*
 * File:   LpFormatGraphToTreeDecompositionProcessor.hpp
 *
...
#ifndef HTD_IO_LPFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP
#define HTD_IO_LPFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP
...
namespace htd_io
{
     ...
     */
    class LpFormatGraphToTreeDecompositionProcessor : public htd_io::IGraphToTreeDecompositionProcessor
    {
        public:
            /**
             *  Constructor for a new graph processor.
             */
            HTD_IO_API LpFormatGraphToTreeDecompositionProcessor(const htd::LibraryInstance * const manager);

            /**
             *  Destructor of a graph processor.
             */
            HTD_IO_API virtual ~LpFormatGraphToTreeDecompositionProcessor();
...
#endif /* HTD_IO_LPFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP */
