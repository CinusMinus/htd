...
#ifndef HTD_IO_HGRFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP
#define HTD_IO_HGRFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP
...
namespace htd_io
{
     ...
     */
    class HgrFormatGraphToTreeDecompositionProcessor : public htd_io::IGraphToTreeDecompositionProcessor
    {
        public:
            /**
             *  Constructor for a new graph processor.
             */
            HTD_IO_API HgrFormatGraphToTreeDecompositionProcessor(const htd::LibraryInstance * const manager);
...
#endif /* HTD_IO_HGRFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP */
